...
exports.validate = (method) => {
    switch (method) {
        ...
        case 'addCourseToProgram': {
            return [
                body('courseId', 'CourseId must be filled').exists().isNumeric().withMessage('Id must be a numeric value'),
                body('educationalProgramId', 'ProgramId must be filled').exists().isNumeric().withMessage('Id must be a numeric value')
            ]
        }
